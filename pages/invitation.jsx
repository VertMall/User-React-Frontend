...
const Invitation = () => {
  ...
  return (
    <>
      <Head>
        <title>You're Invited - The Vert Mall Grand Opening</title>
        <meta name="description" content="Join us for the grand opening of The Vert Mall on 21st August 2026 at 10:00 AM" />
      </Head>
      ...
      <div className="invitation-container">
        ...
        {/* Styles */}
        <style jsx>{`
          /* Paste ALL the CSS from LaunchInvitation.css here */
          /* But remove the .invitation-container background and adjust for Next.js */
        `}</style>
      </div>
    </>
  );
